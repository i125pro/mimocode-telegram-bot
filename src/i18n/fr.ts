...
export const fr: I18nDictionary = {
  ...
  "cmd.description.mimocode_start": "Démarrer le serveur MiMoCode",
  "cmd.description.mimocode_stop": "Arrêter le serveur MiMoCode",
  ...
  "bot.prompt_send_error": "Impossible d'envoyer la requête à MiMoCode.",
  "bot.session_error": "🔴 MiMoCode a renvoyé une erreur : {message}",
  "bot.session_retry":
  ...
  "bot.media_group_not_processed":
    "⚠️ Un ou plusieurs fichiers de cet album ne peuvent pas être traités. Rien n'a été envoyé à MiMoCode.",
  "bot.media_group_download_error":
    "🔴 Impossible de télécharger l'un des fichiers. Rien n'a été envoyé à MiMoCode.",
  "bot.model_no_pdf":
  ...
  "status.header_running": "🟢 Le serveur MiMoCode est en cours d'exécution",
  ...
  "status.server_unavailable":
    "🔴 Le serveur MiMoCode est indisponible\n\nUtilisez /mimocode_start pour démarrer le serveur.",
  ...
  "projects.empty":
    "📭 Aucun projet trouvé.\n\nOuvrez un répertoire dans MiMoCode et créez au moins une session, il apparaîtra ensuite ici.",
  ...
  "projects.fetch_error":
    "🔴 Le serveur MiMoCode est indisponible ou une erreur s'est produite lors du chargement des projets.",
  ...
  "sessions.fetch_error":
    "🔴 Le serveur MiMoCode est indisponible ou une erreur s'est produite lors du chargement des sessions.",
  ...
  "messages.fetch_error":
    "🔴 MiMoCode Server est indisponible ou une erreur est survenue pendant le chargement des messages.",
  ...
  "detach.success":
    "✅ Détaché de la session : {title}\n\nLa session MiMoCode n'a pas été arrêtée. Si elle est toujours en cours, elle continuera séparément. Pour la consulter plus tard, sélectionnez-la à nouveau via /sessions.",
  ...
  "new.create_error":
    "🔴 Le serveur MiMoCode est indisponible ou une erreur s'est produite lors de la création de la session.",
  ...
  "mimocode_start.already_running_managed":
    "⚠️ Le serveur MiMoCode est déjà en cours d'exécution\n\nPID : {pid}\nTemps de fonctionnement : {seconds} secondes",
  "mimocode_start.already_running_external":
    "✅ Le serveur MiMoCode est déjà en cours d'exécution en tant que processus externe\n\nVersion : {version}\n\nCe serveur n'a pas été démarré par le bot, donc /mimocode-stop ne peut pas l'arrêter.",
  "mimocode_start.already_running":
    "✅ Le serveur MiMoCode est déjà en cours d'exécution\n\nVersion : {version}",
  "mimocode_start.remote_configured":
    "⚠️ /mimocode_start fonctionne uniquement avec un serveur MiMoCode local.",
  "mimocode_start.starting": "🔄 Démarrage du serveur MiMoCode...",
  "mimocode_start.start_error":
    "🔴 Impossible de démarrer le serveur MiMoCode\n\nErreur : {error}\n\nVérifiez que l'interface en ligne de commande MiMoCode est installée et disponible dans le PATH :\nmimocode --version\nnpm install -g @mimocode-ai/cli",
  "mimocode_start.started_not_ready":
    "⚠️ Le serveur MiMoCode a démarré, mais ne répond pas encore\n\nPID : {pid}\n\nLe serveur est peut-être encore en cours de démarrage. Essayez /status dans quelques secondes.",
  "mimocode_start.success":
    "✅ Serveur MiMoCode démarré avec succès\n\nPID : {pid}\nVersion : {version}",
  "mimocode_start.error":
    "🔴 Une erreur s'est produite lors du démarrage du serveur.\n\nConsultez les logs de l'application pour plus de détails.",
  "mimocode_stop.external_running":
    "⚠️ Le serveur MiMoCode s'exécute comme processus externe\n\nCe serveur n'a pas été démarré via /mimocode-start.\nArrêtez-le manuellement ou utilisez /status pour vérifier son état.",
  "mimocode_stop.remote_configured":
    "⚠️ /mimocode_stop fonctionne uniquement avec un serveur MiMoCode local.",
  "mimocode_stop.not_running": "⚠️ Le serveur MiMoCode n'est pas en cours d'exécution",
  "mimocode_stop.pid_not_found":
    "⚠️ Le serveur MiMoCode répond sur le port {port}, mais aucun processus local à arrêter n'a été trouvé.",
  "mimocode_stop.stopping": "🛑 Arrêt du serveur MiMoCode...\n\nPID : {pid}",
  "mimocode_stop.stop_error": "🔴 Impossible d'arrêter le serveur MiMoCode\n\nErreur : {error}",
  "mimocode_stop.still_running": "Le serveur répond toujours après la demande d'arrêt.",
  "mimocode_stop.success": "✅ Serveur MiMoCode arrêté avec succès",
  "mimocode_stop.error":
  ...
  "model.menu.favorites_title":
    "⭐ Favoris (ajoutez des modèles aux favoris dans l'interface MiMoCode)",
  "model.menu.favorites_empty": "— Vide.",
  "model.menu.recent_title": "🕘 Récents",
  "model.menu.recent_empty": "— Vide.",
  "model.menu.favorites_hint":
    "ℹ️ Ajoutez des modèles aux favoris dans l'interface MiMoCode pour les garder en tête de liste.",
  ...
  "runtime.wizard.tty_required":
    "L'assistant interactif nécessite un terminal TTY. Exécutez `mimocode-telegram config` dans un shell interactif.",
  ...
  "commands.select": "Choisissez une commande MiMoCode :",
  "commands.empty": "📭 Aucune commande MiMoCode n'est disponible pour ce projet.",
  "commands.fetch_error": "🔴 Impossible de charger les commandes MiMoCode.",
  ...
  "commands.execute_error": "🔴 Impossible d'exécuter la commande MiMoCode.",
  "commands.select_page": "Choisissez une commande MiMoCode (page {page}) :",
  ...
  "skills.select": "Choisissez un skill MiMoCode :",
  "skills.empty": "📭 Aucun skill MiMoCode n'est disponible pour ce projet.",
  "skills.fetch_error": "🔴 Impossible de charger les skills MiMoCode.",
  ...
  "skills.arguments_empty":
    "⚠️ Les arguments ne peuvent pas être vides. Envoyez du texte ou appuyez sur Exécuter.",
  "skills.select_page": "Choisissez un skill MiMoCode (page {page}) :",
  ...
  "legacy.models.empty": "📋 Aucun modèle disponible. Configurez les fournisseurs dans MiMoCode.",
