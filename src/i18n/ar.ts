...
/**
 * Arabic localization for MiMoCode Telegram Bot.
 *
...
export const ar: I18nDictionary = {
  ...
  "cmd.description.mimocode_start": "تشغيل خادم MiMoCode",
  "cmd.description.mimocode_stop": "إيقاف خادم MiMoCode",
  ...
  "bot.prompt_send_error": "تعذر إرسال الطلب إلى MiMoCode.",
  "bot.session_error": "🔴 أعاد MiMoCode الخطأ التالي: {message}",
  ...
  "bot.media_group_not_processed": "⚠️ تعذر معالجة ملف أو أكثر في هذه المجموعة. لم يتم إرسال أي ملف إلى MiMoCode.",
  "bot.media_group_download_error": "🔴 تعذر تنزيل أحد الملفات. لم يتم إرسال أي ملف إلى MiMoCode.",
  ...
  "status.header_running": "🟢 خادم MiMoCode يعمل",
  ...
  "status.server_unavailable": "🔴 خادم MiMoCode غير متاح\n\nاستخدم /mimocode_start لتشغيل الخادم.",
  ...
  "projects.empty": "📭 لم يتم العثور على مشاريع.\n\nافتح مجلدًا في MiMoCode وأنشئ جلسة واحدة على الأقل، ثم سيظهر المشروع هنا.",
  ...
  "projects.fetch_error": "🔴 تعذر تحميل المشاريع. تأكد من أن خادم MiMoCode يعمل ثم حاول مرة أخرى.",
  ...
  "sessions.fetch_error": "🔴 تعذر تحميل الجلسات. تأكد من أن خادم MiMoCode يعمل ثم حاول مرة أخرى.",
  ...
  "messages.fetch_error": "🔴 تعذر تحميل الرسائل. تأكد من أن خادم MiMoCode يعمل ثم حاول مرة أخرى.",
  ...
  "detach.success":
    "✅ تم قطع الاتصال بالجلسة: {title}\n\nلم يتم إيقاف جلسة MiMoCode. إذا كانت لا تزال تعمل، فستستمر بشكل منفصل. للتحقق منها لاحقًا، اخترها مجددًا باستخدام /sessions.",
  ...
  "new.create_error": "🔴 خادم MiMoCode غير متاح أو حدث خطأ أثناء إنشاء الجلسة.",
  ...
  "mimocode_start.already_running_managed":
    "⚠️ خادم MiMoCode يعمل بالفعل\n\nPID: {pid}\nمدة التشغيل: {seconds} ثانية",
  "mimocode_start.already_running_external":
    "✅ خادم MiMoCode يعمل بالفعل كعملية خارجية\n\nالإصدار: {version}\n\nلم يتم تشغيل هذا الخادم بواسطة البوت، لذلك لا يمكن إيقافه باستخدام /mimocode-stop.",
  "mimocode_start.already_running": "✅ خادم MiMoCode يعمل بالفعل\n\nالإصدار: {version}",
  "mimocode_start.remote_configured": "⚠️ يعمل /mimocode_start فقط مع خادم MiMoCode محلي.",
  "mimocode_start.starting": "🔄 جارٍ تشغيل خادم MiMoCode...",
  "mimocode_start.start_error":
    "🔴 تعذر تشغيل خادم MiMoCode\n\nالخطأ: {error}\n\nتأكد من تثبيت MiMoCode CLI وأنه متاح في PATH:\nmimocode --version\nnpm install -g @mimocode-ai/cli",
  "mimocode_start.started_not_ready":
    "⚠️ تم تشغيل خادم MiMoCode، لكنه لا يستجيب\n\nPID: {pid}\n\nقد لا يزال الخادم قيد التشغيل. جرّب /status بعد بضع ثوانٍ.",
  "mimocode_start.success": "✅ تم تشغيل خادم MiMoCode بنجاح\n\nPID: {pid}\nالإصدار: {version}",
  "mimocode_start.error": "🔴 حدث خطأ أثناء تشغيل الخادم.\n\nراجع سجلات التطبيق للتفاصيل.",
  "mimocode_stop.external_running":
    "⚠️ خادم MiMoCode يعمل كعملية خارجية\n\nلم يتم تشغيل هذا الخادم عبر /mimocode-start.\nأوقفه يدويًا أو استخدم /status للتحقق من الحالة.",
  "mimocode_stop.remote_configured": "⚠️ يعمل /mimocode_stop فقط مع خادم MiMoCode محلي.",
  "mimocode_stop.not_running": "⚠️ خادم MiMoCode لا يعمل",
  "mimocode_stop.pid_not_found":
    "⚠️ يستجيب خادم MiMoCode على المنفذ {port}، لكن لم يتم العثور على عملية محلية لإيقافها.",
  "mimocode_stop.stopping": "🛑 جارٍ إيقاف خادم MiMoCode...\n\nPID: {pid}",
  "mimocode_stop.stop_error": "🔴 تعذر إيقاف خادم MiMoCode\n\nالخطأ: {error}",
  "mimocode_stop.still_running": "لا يزال الخادم يستجيب بعد طلب الإيقاف.",
  "mimocode_stop.success": "✅ تم إيقاف خادم MiMoCode بنجاح",
  "mimocode_stop.error": "🔴 حدث خطأ أثناء إيقاف الخادم.\n\nراجع سجلات التطبيق للتفاصيل.",
  ...
  "model.menu.favorites_title": "⭐ المفضلة (أضف النماذج إلى المفضلة من MiMoCode CLI)",
  ...
  "model.menu.favorites_hint": "ℹ️ أضف النماذج إلى المفضلة في MiMoCode CLI لإبقائها أعلى القائمة.",
  ...
  "runtime.wizard.ask_api_url": "أدخل رابط MiMoCode API، أو اضغط Enter لاستخدام الرابط الافتراضي: {defaultUrl}\n> ",
  "runtime.wizard.ask_server_username":
    "أدخل اسم مستخدم خادم MiMoCode (اختياري).\nاضغط Enter لاستخدام القيمة الافتراضية: {defaultUsername}\n> ",
  "runtime.wizard.ask_server_password":
    "أدخل كلمة مرور خادم MiMoCode (اختياري).\nاضغط Enter لتركها فارغة.\n> ",
  "runtime.wizard.api_url_invalid": "أدخل رابطًا صالحًا (http/https) أو اضغط Enter لاستخدام الافتراضي.\n",
  "runtime.wizard.start": "إعداد MiMoCode Telegram Bot.\n",
  ...
  "runtime.wizard.tty_required":
    "يتطلب معالج الإعداد التفاعلي طرفية TTY. شغّل `mimocode-telegram config` في shell تفاعلية.",
  ...
  "commands.select": "اختر أمرًا من MiMoCode:",
  "commands.empty": "📭 لا توجد أوامر مخصصة لهذا المشروع.",
  "commands.fetch_error": "🔴 تعذر تحميل أوامر MiMoCode.",
  ...
  "commands.execute_error": "🔴 تعذر تنفيذ أمر MiMoCode.",
  "commands.select_page": "اختر أمرًا من MiMoCode (الصفحة {page}):",
  ...
  "skills.select": "اختر مهارة من MiMoCode:",
  "skills.empty": "📭 لا توجد مهارات متاحة لهذا المشروع.",
  "skills.fetch_error": "🔴 تعذر تحميل مهارات MiMoCode.",
  ...
  "skills.select_page": "اختر مهارة من MiMoCode (الصفحة {page}):",
  ...
  "legacy.models.empty": "📋 لا توجد نماذج متاحة. اضبط المزوّدين في MiMoCode.",
