...
export const ru: I18nDictionary = {
  ...
  "cmd.description.mimocode_start": "Запустить MiMoCode сервер",
  "cmd.description.mimocode_stop": "Остановить MiMoCode сервер",
  ...
  "bot.prompt_send_error": "Не удалось отправить запрос в MiMoCode.",
  "bot.session_error": "🔴 MiMoCode вернул ошибку: {message}",
  "bot.session_retry":
  ...
  "bot.media_group_not_processed":
    "⚠️ Один или несколько файлов в альбоме нельзя обработать. В MiMoCode ничего не отправлено.",
  "bot.media_group_download_error":
    "🔴 Не удалось скачать один из файлов. В MiMoCode ничего не отправлено.",
  ...
  "status.header_running": "🟢 MiMoCode Server запущен",
  ...
  "status.server_unavailable":
    "🔴 MiMoCode Server недоступен\n\nИспользуйте /mimocode_start для запуска сервера.",
  ...
  "projects.empty":
    "📭 Проектов нет.\n\nОткройте директорию в MiMoCode и создайте хотя бы одну сессию, после этого она появится здесь.",
  ...
  "projects.fetch_error":
    "🔴 MiMoCode Server недоступен или произошла ошибка при получении списка проектов.",
  ...
  "sessions.fetch_error":
    "🔴 MiMoCode Server недоступен или произошла ошибка при получении списка сессий.",
  ...
  "messages.fetch_error":
    "🔴 MiMoCode Server недоступен или произошла ошибка при получении списка сообщений.",
  ...
  "detach.success":
    "✅ Отсоединился от сессии: {title}\n\nMiMoCode-сессия не остановлена. Если она еще выполняется, выполнение продолжится отдельно. Чтобы проверить ее позже, снова выберите эту сессию через /sessions.",
  ...
  "new.create_error": "🔴 MiMoCode Server недоступен или произошла ошибка при создании сессии.",
  ...
  "mimocode_start.already_running_managed":
    "⚠️ MiMoCode Server уже запущен\n\nPID: {pid}\nUptime: {seconds} секунд",
  "mimocode_start.already_running_external":
    "✅ MiMoCode Server уже запущен внешним процессом\n\nВерсия: {version}\n\nЭтот сервер не был запущен через бота, поэтому команда /mimocode-stop не сможет его остановить.",
  "mimocode_start.already_running": "✅ MiMoCode Server уже запущен\n\nВерсия: {version}",
  "mimocode_start.remote_configured":
    "⚠️ /mimocode_start работает только с локальным MiMoCode Server.",
  "mimocode_start.starting": "🔄 Запускаю MiMoCode Server...",
  "mimocode_start.start_error":
    "🔴 Не удалось запустить MiMoCode Server\n\nОшибка: {error}\n\nПроверьте, что MiMoCode CLI установлен и доступен в PATH:\nmimocode --version\nnpm install -g @mimocode-ai/cli",
  "mimocode_start.started_not_ready":
    "⚠️ MiMoCode Server запущен, но не отвечает\n\nPID: {pid}\n\nСервер может запускаться. Попробуйте /status через несколько секунд.",
  "mimocode_start.success": "✅ MiMoCode Server успешно запущен\n\nPID: {pid}\nВерсия: {version}",
  ...
  "mimocode_stop.external_running":
    "⚠️ MiMoCode Server запущен внешним процессом\n\nЭтот сервер не был запущен через /mimocode-start.\nОстановите его вручную или используйте /status для проверки состояния.",
  "mimocode_stop.remote_configured":
    "⚠️ /mimocode_stop работает только с локальным MiMoCode Server.",
  "mimocode_stop.not_running": "⚠️ MiMoCode Server не запущен",
  "mimocode_stop.pid_not_found":
    "⚠️ MiMoCode Server отвечает на порту {port}, но локальный процесс для остановки найти не удалось.",
  "mimocode_stop.stopping": "🛑 Останавливаю MiMoCode Server...\n\nPID: {pid}",
  "mimocode_stop.stop_error": "🔴 Не удалось остановить MiMoCode Server\n\nОшибка: {error}",
  "mimocode_stop.still_running": "Сервер все еще отвечает после запроса на остановку.",
  "mimocode_stop.success": "✅ MiMoCode Server успешно остановлен",
  "mimocode_stop.error":
  ...
  "model.menu.favorites_title": "⭐ Избранное (Добавляйте модели в избранное через MiMoCode CLI)",
  "model.menu.favorites_empty": "— Список пуст.",
  "model.menu.recent_title": "🕘 Недавние",
  "model.menu.recent_empty": "— Список пуст.",
  "model.menu.favorites_hint":
    "ℹ️ Добавляйте модели в избранное через MiMoCode CLI, чтобы они были вверху списка.",
  ...
  "commands.select": "Выберите команду MiMoCode:",
  "commands.empty": "📭 Для этого проекта нет доступных команд MiMoCode.",
  "commands.fetch_error": "🔴 Не удалось загрузить список команд MiMoCode.",
  ...
  "commands.execute_error": "🔴 Не удалось выполнить команду MiMoCode.",
  "commands.select_page": "Выберите команду MiMoCode (страница {page}):",
  ...
  "skills.select": "Выберите скилл MiMoCode:",
  "skills.empty": "📭 Для этого проекта нет доступных скиллов MiMoCode.",
  "skills.fetch_error": "🔴 Не удалось загрузить список скиллов MiMoCode.",
  ...
  "skills.arguments_empty":
    "⚠️ Аргументы не могут быть пустыми. Отправьте текст или нажмите Выполнить.",
  "skills.select_page": "Выберите скилл MiMoCode (страница {page}):",
  ...
  "legacy.models.empty": "📋 Нет доступных моделей. Настройте провайдеры через MiMoCode.",
