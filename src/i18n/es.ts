...
export const es: I18nDictionary = {
  ...
  "cmd.description.mimocode_start": "Iniciar servidor MiMoCode",
  "cmd.description.mimocode_stop": "Detener servidor MiMoCode",
  ...
  "bot.prompt_send_error": "No se pudo enviar la solicitud a MiMoCode.",
  "bot.session_error": "🔴 MiMoCode devolvió un error: {message}",
  "bot.session_retry":
  ...
  "bot.media_group_not_processed":
    "⚠️ Uno o más archivos de este álbum no se pueden procesar. No se envió nada a MiMoCode.",
  "bot.media_group_download_error":
    "🔴 No se pudo descargar uno de los archivos. No se envió nada a MiMoCode.",
  ...
  "status.header_running": "🟢 MiMoCode Server está en ejecución",
  ...
  "status.server_unavailable":
    "🔴 MiMoCode Server no está disponible\n\nUsa /mimocode_start para iniciar el servidor.",
  ...
  "projects.empty":
    "📭 No se encontraron proyectos.\n\nAbre un directorio en MiMoCode y crea al menos una sesión; entonces aparecerá aquí.",
  ...
  "projects.fetch_error":
    "🔴 MiMoCode Server no está disponible u ocurrió un error al cargar los proyectos.",
  ...
  "sessions.fetch_error":
    "🔴 MiMoCode Server no está disponible u ocurrió un error al cargar las sesiones.",
  ...
  "messages.fetch_error":
    "🔴 MiMoCode Server no está disponible o se produjo un error al cargar los mensajes.",
  ...
  "detach.success":
    "✅ Desconectado de la sesión: {title}\n\nLa sesión de MiMoCode no se detuvo. Si todavía está en ejecución, continuará por separado. Para revisarla más tarde, selecciónala de nuevo con /sessions.",
  ...
  "new.create_error":
    "🔴 MiMoCode Server no está disponible u ocurrió un error al crear la sesión.",
  ...
  "mimocode_start.already_running_managed":
    "⚠️ MiMoCode Server ya está en ejecución\n\nPID: {pid}\nTiempo activo: {seconds} segundos",
  "mimocode_start.already_running_external":
    "✅ MiMoCode Server ya está en ejecución como un proceso externo\n\nVersión: {version}\n\nEste servidor no fue iniciado por el bot, por lo que /mimocode-stop no puede detenerlo.",
  "mimocode_start.already_running": "✅ MiMoCode Server ya está en ejecución\n\nVersión: {version}",
  "mimocode_start.remote_configured":
    "⚠️ /mimocode_start solo funciona con un MiMoCode Server local.",
  "mimocode_start.starting": "🔄 Iniciando MiMoCode Server...",
  "mimocode_start.start_error":
    "🔴 No se pudo iniciar MiMoCode Server\n\nError: {error}\n\nRevisa que MiMoCode CLI esté instalado y disponible en PATH:\nmimocode --version\nnpm install -g @mimocode-ai/cli",
  "mimocode_start.started_not_ready":
    "⚠️ MiMoCode Server se inició, pero no responde\n\nPID: {pid}\n\nEl servidor puede estar iniciando. Prueba /status en unos segundos.",
  "mimocode_start.success":
    "✅ MiMoCode Server iniciado correctamente\n\nPID: {pid}\nVersión: {version}",
  ...
  "mimocode_stop.external_running":
    "⚠️ MiMoCode Server está en ejecución como un proceso externo\n\nEste servidor no fue iniciado con /mimocode-start.\nDeténlo manualmente o usa /status para revisar el estado.",
  "mimocode_stop.remote_configured":
    "⚠️ /mimocode_stop solo funciona con un MiMoCode Server local.",
  "mimocode_stop.not_running": "⚠️ MiMoCode Server no está en ejecución",
  "mimocode_stop.pid_not_found":
    "⚠️ MiMoCode Server responde en el puerto {port}, pero no se encontró ningún proceso local para detenerlo.",
  "mimocode_stop.stopping": "🛑 Deteniendo MiMoCode Server...\n\nPID: {pid}",
  "mimocode_stop.stop_error": "🔴 No se pudo detener MiMoCode Server\n\nError: {error}",
  "mimocode_stop.still_running":
    "El servidor sigue respondiendo después de la solicitud de detención.",
  "mimocode_stop.success": "✅ MiMoCode Server detenido correctamente",
  "mimocode_stop.error":
  ...
  "model.menu.favorites_title": "⭐ Favoritos (Agrega modelos a favoritos en MiMoCode CLI)",
  "model.menu.favorites_empty": "— Vacío.",
  "model.menu.recent_title": "🕘 Recientes",
  "model.menu.recent_empty": "— Vacío.",
  "model.menu.favorites_hint":
    "ℹ️ Agrega modelos a favoritos en MiMoCode CLI para mantenerlos arriba de la lista.",
  ...
  "commands.select": "Elige un comando de MiMoCode:",
  "commands.empty": "📭 No hay comandos de MiMoCode disponibles para este proyecto.",
  "commands.fetch_error": "🔴 No se pudieron cargar los comandos de MiMoCode.",
  ...
  "commands.execute_error": "🔴 No se pudo ejecutar el comando de MiMoCode.",
  "commands.select_page": "Elige un comando de MiMoCode (página {page}):",
  ...
  "skills.select": "Elige un skill de MiMoCode:",
  "skills.empty": "📭 No hay skills de MiMoCode disponibles para este proyecto.",
  "skills.fetch_error": "🔴 No se pudieron cargar los skills de MiMoCode.",
  ...
  "skills.arguments_empty":
    "⚠️ Los argumentos no pueden estar vacíos. Envía texto o toca Ejecutar.",
  "skills.select_page": "Elige un skill de MiMoCode (página {page}):",
  ...
  "legacy.models.empty": "📋 No hay modelos disponibles. Configura los proveedores en MiMoCode.",
