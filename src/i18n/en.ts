export const en = {
  ...
  "cmd.description.mimocode_start": "Start MiMoCode server",
  "cmd.description.mimocode_stop": "Stop MiMoCode server",
  ...
  "bot.prompt_send_error": "Failed to send request to MiMoCode.",
  "bot.session_error": "🔴 MiMoCode returned an error: {message}",
  "bot.session_retry":
  ...
  "bot.media_group_not_processed":
    "⚠️ One or more files in this album cannot be processed. Nothing was sent to MiMoCode.",
  "bot.media_group_download_error":
    "🔴 Failed to download one of the files. Nothing was sent to MiMoCode.",
  ...
  "status.header_running": "🟢 MiMoCode Server is running",
  ...
  "status.server_unavailable":
    "🔴 MiMoCode Server is unavailable\n\nUse /mimocode_start to start the server.",
  ...
  "projects.empty":
    "📭 No projects found.\n\nOpen a directory in MiMoCode and create at least one session, then it will appear here.",
  ...
  "projects.fetch_error":
    "🔴 MiMoCode Server is unavailable or an error occurred while loading projects.",
  ...
  "sessions.fetch_error":
    "🔴 MiMoCode Server is unavailable or an error occurred while loading sessions.",
  ...
  "messages.fetch_error":
    "🔴 MiMoCode Server is unavailable or an error occurred while loading messages.",
  ...
  "detach.success":
    "✅ Detached from session: {title}\n\nThe MiMoCode session was not stopped. If it is still running, it will continue separately. To check it later, select it again via /sessions.",
  ...
  "new.create_error":
    "🔴 MiMoCode Server is unavailable or an error occurred while creating session.",
  ...
  "mimocode_start.already_running_managed":
    "⚠️ MiMoCode Server is already running\n\nPID: {pid}\nUptime: {seconds} seconds",
  "mimocode_start.already_running_external":
    "✅ MiMoCode Server is already running as an external process\n\nVersion: {version}\n\nThis server was not started by bot, so /mimocode-stop cannot stop it.",
  "mimocode_start.already_running": "✅ MiMoCode Server is already running\n\nVersion: {version}",
  "mimocode_start.remote_configured": "⚠️ /mimocode_start works only with a local MiMoCode Server.",
  "mimocode_start.starting": "🔄 Starting MiMoCode Server...",
  "mimocode_start.start_error":
    "🔴 Failed to start MiMoCode Server\n\nError: {error}\n\nCheck that MiMoCode CLI is installed and available in PATH:\nmimocode --version\nnpm install -g @mimocode-ai/cli",
  "mimocode_start.started_not_ready":
    "⚠️ MiMoCode Server started, but is not responding\n\nPID: {pid}\n\nServer may still be starting. Try /status in a few seconds.",
  "mimocode_start.success":
    "✅ MiMoCode Server started successfully\n\nPID: {pid}\nVersion: {version}",
  "mimocode_start.error":
    "🔴 An error occurred while starting server.\n\nCheck application logs for details.",
  "mimocode_stop.external_running":
    "⚠️ MiMoCode Server is running as an external process\n\nThis server was not started via /mimocode-start.\nStop it manually or use /status to check state.",
  "mimocode_stop.remote_configured": "⚠️ /mimocode_stop works only with a local MiMoCode Server.",
  "mimocode_stop.not_running": "⚠️ MiMoCode Server is not running",
  "mimocode_stop.pid_not_found":
    "⚠️ MiMoCode Server responds on port {port}, but no local process was found to stop.",
  "mimocode_stop.stopping": "🛑 Stopping MiMoCode Server...\n\nPID: {pid}",
  "mimocode_stop.stop_error": "🔴 Failed to stop MiMoCode Server\n\nError: {error}",
  "mimocode_stop.still_running": "Server is still responding after the stop request.",
  "mimocode_stop.success": "✅ MiMoCode Server stopped successfully",
  "mimocode_stop.error":
  ...
  "model.menu.favorites_title": "⭐ Favorites (Add models to favorites in MiMoCode CLI)",
  "model.menu.favorites_empty": "— Empty.",
  "model.menu.recent_title": "🕘 Recent",
  "model.menu.recent_empty": "— Empty.",
  "model.menu.favorites_hint":
    "ℹ️ Add models to favorites in MiMoCode CLI to keep them at the top.",
  ...
  "commands.select": "Choose an MiMoCode command:",
  "commands.empty": "📭 No MiMoCode commands are available for this project.",
  "commands.fetch_error": "🔴 Failed to load MiMoCode commands.",
  ...
  "commands.execute_error": "🔴 Failed to execute MiMoCode command.",
  "commands.select_page": "Choose an MiMoCode command (page {page}):",
  ...
  "skills.select": "Choose an MiMoCode skill:",
  "skills.empty": "📭 No MiMoCode skills are available for this project.",
  "skills.fetch_error": "🔴 Failed to load MiMoCode skills.",
  ...
  "skills.select_page": "Choose an MiMoCode skill (page {page}):",
  ...
  "legacy.models.empty": "📋 No available models. Configure providers in MiMoCode.",
