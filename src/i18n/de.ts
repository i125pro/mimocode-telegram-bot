...
export const de: I18nDictionary = {
  ...
  "cmd.description.mimocode_start": "MiMoCode-Server starten",
  "cmd.description.mimocode_stop": "MiMoCode-Server stoppen",
  ...
  "bot.prompt_send_error": "Anfrage konnte nicht an MiMoCode gesendet werden.",
  "bot.session_error": "🔴 MiMoCode meldete einen Fehler: {message}",
  "bot.session_retry":
  ...
  "bot.media_group_not_processed":
    "⚠️ Eine oder mehrere Dateien in diesem Album können nicht verarbeitet werden. Es wurde nichts an MiMoCode gesendet.",
  "bot.media_group_download_error":
    "🔴 Eine der Dateien konnte nicht heruntergeladen werden. Es wurde nichts an MiMoCode gesendet.",
  ...
  "status.header_running": "🟢 MiMoCode-Server läuft",
  ...
  "status.server_unavailable":
    "🔴 MiMoCode-Server ist nicht verfügbar\n\nNutze /mimocode_start, um den Server zu starten.",
  ...
  "projects.empty":
    "📭 Keine Projekte gefunden.\n\nÖffne ein Verzeichnis in MiMoCode und erstelle mindestens eine Sitzung, dann erscheint es hier.",
  ...
  "projects.fetch_error":
    "🔴 MiMoCode-Server ist nicht verfügbar oder beim Laden der Projekte ist ein Fehler aufgetreten.",
  ...
  "sessions.fetch_error":
    "🔴 MiMoCode-Server ist nicht verfügbar oder beim Laden der Sitzungen ist ein Fehler aufgetreten.",
  ...
  "messages.fetch_error":
    "🔴 MiMoCode Server ist nicht erreichbar oder beim Laden der Nachrichten ist ein Fehler aufgetreten.",
  ...
  "detach.success":
    "✅ Von Sitzung getrennt: {title}\n\nDie MiMoCode-Sitzung wurde nicht gestoppt. Falls sie noch läuft, läuft sie separat weiter. Um sie später zu prüfen, wähle sie erneut über /sessions aus.",
  ...
  "new.create_error":
    "🔴 MiMoCode-Server ist nicht verfügbar oder beim Erstellen der Sitzung ist ein Fehler aufgetreten.",
  ...
  "mimocode_start.already_running_managed":
    "⚠️ MiMoCode-Server läuft bereits\n\nPID: {pid}\nBetriebszeit: {seconds} Sekunden",
  "mimocode_start.already_running_external":
    "✅ MiMoCode-Server läuft bereits als externer Prozess\n\nVersion: {version}\n\nDieser Server wurde nicht vom Bot gestartet, daher kann /mimocode-stop ihn nicht stoppen.",
  "mimocode_start.already_running": "✅ MiMoCode-Server läuft bereits\n\nVersion: {version}",
  "mimocode_start.remote_configured":
    "⚠️ /mimocode_start funktioniert nur mit einem lokalen MiMoCode-Server.",
  "mimocode_start.starting": "🔄 Starte MiMoCode-Server...",
  "mimocode_start.start_error":
    "🔴 MiMoCode-Server konnte nicht gestartet werden\n\nFehler: {error}\n\nPrüfe, ob MiMoCode CLI installiert und im PATH verfügbar ist:\nmimocode --version\nnpm install -g @mimocode-ai/cli",
  "mimocode_start.started_not_ready":
    "⚠️ MiMoCode-Server gestartet, aber reagiert nicht\n\nPID: {pid}\n\nDer Server startet möglicherweise noch. Versuche /status in ein paar Sekunden.",
  "mimocode_start.success":
    "✅ MiMoCode-Server erfolgreich gestartet\n\nPID: {pid}\nVersion: {version}",
  ...
  "mimocode_stop.external_running":
    "⚠️ MiMoCode-Server läuft als externer Prozess\n\nDieser Server wurde nicht über /mimocode-start gestartet.\nStoppe ihn manuell oder nutze /status, um den Zustand zu prüfen.",
  "mimocode_stop.remote_configured":
    "⚠️ /mimocode_stop funktioniert nur mit einem lokalen MiMoCode-Server.",
  "mimocode_stop.not_running": "⚠️ MiMoCode-Server läuft nicht",
  "mimocode_stop.pid_not_found":
    "⚠️ MiMoCode-Server antwortet auf Port {port}, aber es wurde kein lokaler Prozess zum Stoppen gefunden.",
  "mimocode_stop.stopping": "🛑 Stoppe MiMoCode-Server...\n\nPID: {pid}",
  "mimocode_stop.stop_error": "🔴 MiMoCode-Server konnte nicht gestoppt werden\n\nFehler: {error}",
  "mimocode_stop.still_running": "Der Server antwortet nach der Stop-Anfrage weiterhin.",
  "mimocode_stop.success": "✅ MiMoCode-Server erfolgreich gestoppt",
  "mimocode_stop.error":
  ...
  "model.menu.favorites_title":
    "⭐ Favoriten (Füge Modelle in MiMoCode CLI zu den Favoriten hinzu)",
  "model.menu.favorites_empty": "— Leer.",
  "model.menu.recent_title": "🕘 Zuletzt verwendet",
  "model.menu.recent_empty": "— Leer.",
  "model.menu.favorites_hint":
    "ℹ️ Füge Modelle in MiMoCode CLI zu den Favoriten hinzu, damit sie oben angezeigt werden.",
  ...
  "commands.select": "Wähle einen MiMoCode-Befehl:",
  "commands.empty": "📭 Für dieses Projekt sind keine MiMoCode-Befehle verfügbar.",
  "commands.fetch_error": "🔴 MiMoCode-Befehle konnten nicht geladen werden.",
  ...
  "commands.execute_error": "🔴 MiMoCode-Befehl konnte nicht ausgeführt werden.",
  "commands.select_page": "Wähle einen MiMoCode-Befehl (Seite {page}):",
  ...
  "skills.select": "Wähle einen MiMoCode-Skill:",
  "skills.empty": "📭 Für dieses Projekt sind keine MiMoCode-Skills verfügbar.",
  "skills.fetch_error": "🔴 MiMoCode-Skills konnten nicht geladen werden.",
  ...
  "skills.arguments_empty":
    "⚠️ Argumente dürfen nicht leer sein. Sende Text oder tippe auf Ausführen.",
  "skills.select_page": "Wähle einen MiMoCode-Skill (Seite {page}):",
  ...
  "legacy.models.empty": "📋 Keine verfügbaren Modelle. Konfiguriere Provider in MiMoCode.",
