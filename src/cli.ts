...
const CLI_USAGE = `Usage:
  mimocode-telegram [start] [--daemon] [--mode installed]
...
const CLI_MESSAGES = {
  daemonRequiresInstalled:
    "Daemon mode is supported only for the installed runtime. Use `mimocode-telegram start` for foreground source runs.",
  ...
  startSuccess: "MiMoCode Telegram Bot daemon started.",
  startAlreadyRunning: "MiMoCode Telegram Bot daemon is already running.",
  statusRunning: "Service status: running",
  statusStopped: "Service status: stopped",
  stopSuccess: "MiMoCode Telegram Bot daemon stopped.",
  stopAlreadyStopped: "MiMoCode Telegram Bot daemon is not running.",
